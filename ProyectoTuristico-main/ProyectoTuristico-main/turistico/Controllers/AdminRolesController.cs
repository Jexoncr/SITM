...
namespace turistico.Controllers
{
    ...
    public class AdminRolesController : Controller
    {
        ...
        public async Task<ActionResult> Create(string name)
        {
            ...
            TempData[res.Succeeded ? "Ok" : "Err"] = res.Succeeded ? "Rol creado." : string.Join(" | ", res.Errors);
        ...
        public async Task<ActionResult> Delete(string id)
        {
            ...
            // Evitar borrar Admin por accidente
            if (role.Name == "Admin")
            {
            ...
            TempData[res.Succeeded ? "Ok" : "Err"] = res.Succeeded ? "Rol eliminado." : string.Join(" | ", res.Errors);
